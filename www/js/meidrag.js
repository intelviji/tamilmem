...
$(" #draggable16" ).draggable({ revert: "invalid" });
$(" #draggable17" ).draggable({ revert: "invalid" });
$(" #draggable18" ).draggable({ revert: "invalid" });
...
{
$("#clap").get(0).play();
$.fn.displayOverlay('<a href="drag_menu.html"><img src="../img/../img/quiz_end1.png" /></a>');
}
